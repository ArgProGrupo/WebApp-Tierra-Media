...
<div class="input-group mb-3">
	<span class="input-group-text" id="inputGroup-sizing-default"><label
		for="costo" class="col-form-label">Costo:</label></span><input type="number"
...
<div class="input-group mb-3">
	<span class="input-group-text" id="inputGroup-sizing-default"><label
		...
		type="number" class="form-control" id="tiempo" name="tiempo" required
		value="${atraccion.tiempo}" aria-label="Sizing example input"
		aria-describedby="inputGroup-sizing-lg">
</div>
