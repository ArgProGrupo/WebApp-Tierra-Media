...
<body>
	...
	<main>
		...
		<form action="create.do" method="post">
			...
			<div class="mb-3">
				<label for="tipoAtraccion" class="col-form-label">Tipo Atraccion Favorita:</label> <input
					type="text" class="form-control" id="tipoAtraccion" name="tipoAtraccion" required
